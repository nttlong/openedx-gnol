...
//        sort: base_sort++,
        ...
        init:function(ele){
            if($(ele))
            return unescape(decodeURIComponent($(ele[0]).attr("data-description")))
...
Vvveb.Components.extend("_base", "html/numericinput", {
    name: "Numeric Input",
...
Vvveb.Components.add("html/grid4cols", {
    name: "Grid Row 4 columns",
    image: "icons/grid_row.svg",
    classes: ["row"],
    html: '<div class="row">'+
           '<div class="col-sm-2"><span>label</span></div>'+
           '<div class="col-sm-4 col-5"><input type="text" class="form-control"/></div>'+
           '<div class="col-sm-2"><span>label</span></div>'+
           '<div class="col-sm-4 col-5"><input type="text" class="form-control"/></div>'+
//           '<div class="col-sm-4"><h3>col-sm-4</h3></div>'+
           '</div>',
