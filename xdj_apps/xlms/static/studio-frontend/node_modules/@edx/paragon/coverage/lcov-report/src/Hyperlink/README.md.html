...
<html lang="en">
<head>
    <title>Code coverage report for src/Hyperlink/README.md</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Hyperlink</a> README.md
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"># Hyperlink
&nbsp;
## API
&nbsp;
...
&nbsp;
**This value is required if the `target` value is `_blank`**</pre></td></tr>
</table></pre>
