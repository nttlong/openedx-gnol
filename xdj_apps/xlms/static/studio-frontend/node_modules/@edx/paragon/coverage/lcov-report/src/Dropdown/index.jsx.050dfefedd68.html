...
<html lang="en">
<head>
    <title>Code coverage report for src/Dropdown/index.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Dropdown</a> index.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  componentDidUpdate() {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.toggleElem) {
