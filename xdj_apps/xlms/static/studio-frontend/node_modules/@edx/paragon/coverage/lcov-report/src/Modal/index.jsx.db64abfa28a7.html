...
<html lang="en">
<head>
    <title>Code coverage report for src/Modal/index.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Modal</a> index.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  componentDidMount() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.firstFocusableElement) {
...
&nbsp;
  handleKeyDown(e) {
    if (e.key === 'Escape') {
      ...
      if (e.shiftKey) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (e.target === this.firstFocusableElement) {
          e.preventDefault();
