...
<html lang="en">
<head>
    <title>Code coverage report for lib/backbone.paginator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> backbone.paginator.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.75% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>447/462</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.08% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>347/381</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>411/420</span>
      </div>
    </div>
  </div>
...
1374
1375
1376</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  // CommonJS
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof exports == "object" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof require == "function")</span> {
<span class="cstat-no" title="statement not covered" >    module.exports = factory(require("underscore"), require("backbone"));</span>
  }
  // AMD
...
<span class="cstat-no" title="statement not covered" >    define(["underscore", "backbone"], factory);</span>
  }
  // Browser
  else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof _ !== "undefined" &amp;&amp; typeof Backbone !== "undefined") {
...
&nbsp;
    ...
    */
    Backbone.PageableCollection.noConflict = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      Backbone.PageableCollection = oldPageableCollection;</span>
<span class="cstat-no" title="statement not covered" >      return PageableCollection;</span>
    };
  }
&nbsp;
}(function (_, Backbone) {
...
&nbsp;
  ...
  var _pairs = _.pairs || <span class="branch-1 cbranch-no" title="branch not covered" >_.toPairs;</span>
...
&nbsp;
  function queryStringToParams (qs) {
    ...
    for (var i = 0, l = kvps.length; i &lt; l; i++) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (v == null) <span class="cstat-no" title="statement not covered" >v = true;</span>
      k = decode(k), v = decode(v), ls = params[k];
      <span class="missing-if-branch" title="if path not taken" >I</span>if (_isArray(ls)) <span class="cstat-no" title="statement not covered" >ls.push(v);</span>
      else <span class="missing-if-branch" title="if path not taken" >I</span>if (ls) <span class="cstat-no" title="statement not covered" >params[k] = [ls, v];</span>
      else params[k] = v;
    }
    return params;
  }
...
&nbsp;
      options = options || {};
&nbsp;
      var mode = this.mode = options.mode || this.mode || <span class="branch-2 cbranch-no" title="branch not covered" >PageableProto.mode;</span>
&nbsp;
...
&nbsp;
        if (event == "add") {
          var pageIndex, fullIndex, addAt, colToAdd, options = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.silent) pageCol.trigger("pageable:state:change", pageCol.state);
        }
&nbsp;
        ...
        if (event == "remove") {
          if (!options.onAdd) {
            ...
            if (!--state.totalRecords) {
              ...
              state.lastPage = firstPage === 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >totalPages - 1 </span>: totalPages || <span class="branch-1 cbranch-no" title="branch not covered" >firstPage;</span>
...
&nbsp;
          ...
          if (collection == pageCol &amp;&amp; options.from == null &amp;&amp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (pageCol.mode == "client") {
              firstPage = state.lastPage = state.currentPage = state.firstPage;
              currentPage = firstPage === 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >state.currentPage </span>: state.currentPage - 1;
...
&nbsp;
        _each(_keys(handlers), function (event) {
          ...
          _each([pageCol, fullCol], function (col) {
            ...
            var callbacks = col._events[event] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
&nbsp;
        if (mode == "infinite") {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!links[currentPage]) {
<span class="cstat-no" title="statement not covered" >            throw new RangeError("No link found for page " + currentPage);</span>
          }
        }
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_contains(["server", "client", "infinite"], mode)) {
<span class="cstat-no" title="statement not covered" >        throw new TypeError('`mode` must be one of "server", "client" or "infinite"');</span>
      }
&nbsp;
...
&nbsp;
      ...
      else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.links) <span class="cstat-no" title="statement not covered" >delete this.links;</span>
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.silent) this.trigger("pageable:state:change", state);
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw new RangeError("`offset must be &gt; 0`");</span>
      }
      offset = finiteInt(offset, "offset");
&nbsp;
      var page = floor(offset / this.state.pageSize);
      if (this.state.firstPage !== 0) page++;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (page &gt; this.state.lastPage) <span class="cstat-no" title="statement not covered" >page = this.state.lastPage;</span>
    ...
    sync: function (method, model, options) {
      ...
      if (self.mode == "infinite") {
        ...
        options.success = function (resp, status, xhr) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (newLinks.prev) <span class="cstat-no" title="statement not covered" >links[currentPage - 1] = newLinks.prev;</span>
          if (newLinks.next) links[currentPage + 1] = newLinks.next;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (success) success(resp, status, xhr);
        };
      }
&nbsp;
      return (BBColProto.sync || <span class="branch-1 cbranch-no" title="branch not covered" >Backbone.sync)</span>.call(self, method, model, options);
    },
&nbsp;
    /**
...
&nbsp;
      // dedup query params
      var url = options.url || this.url || <span class="branch-2 cbranch-no" title="branch not covered" >"";</span>
...
&nbsp;
      ...
      _each(queryParams, function (v, k) {
        v = _isFunction(v) ? <span class="branch-0 cbranch-no" title="branch not covered" >v.call(this) </span>: v;
...
<span class="branch-0 cbranch-no" title="branch not covered" >          this.queryParams.sortKey.call(this) </span>:
...
&nbsp;
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (_isUndefined(options.silent)) delete opts.silent;
          else <span class="cstat-no" title="statement not covered" >opts.silent = options.silent;</span>
&nbsp;
...
&nbsp;
      if (side == "client") {
        if (full) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (fullCollection) fullCollection.comparator = comparator;
          delComp = true;
        }
        else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Jun 03 2017 01:22:52 GMT+0100 (BST)
</div>
</div>
